...
6. **Connect Telegram + health check:** open `https://<your-app>.vercel.app/api/setup` (connects the webhook and reports what works). Or: `npm run set-webhook -- https://<your-app>.vercel.app` (or open this URL in a browser):
